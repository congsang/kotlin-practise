package com.example.sangnguyen.imageslider
...
class MainActivity : AppCompatActivity() {
    ...
    val images: IntArray = intArrayOf(R.drawable.img_1, R.drawable.img_2,
    ...
    private fun setupView() {
        val adapter: PagerAdapter = SliderPageAdapter(this, images)
